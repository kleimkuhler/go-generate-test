...
var testtypesResource = schema.GroupVersionResource{Group: "foo.bar", Version: "v1", Resource: "testtypes"}

var testtypesKind = schema.GroupVersionKind{Group: "foo.bar", Version: "v1", Kind: "TestType"}
